...
let handler = async (m, { conn, command, text }) => {
	...
	try {
		...
		spawn(_spawnprocess, _spawnargs)
			...
			.on('close', async () => {
				await conn.sendMessage(m.chat, { image: Buffer.concat(bufs), caption: 'Hati² ketahuan:v' }, { quoted: m, ephemeralExpiration: ephemeral })
			})
